...
MIGRATION_MODULES = {
    # "sites": "sloth.contrib.sites.migrations"
}
...
ADMINS = [("""Brian Dunnette""", "brian@dunnettte.us")]
...
ACCOUNT_FORMS = {"signup": "sloth.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "sloth.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "sloth.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Sloth API",
    "DESCRIPTION": "Documentation of API endpoints of Sloth",
    "VERSION": "1.0.0",
